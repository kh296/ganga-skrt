...
class PatientMvctSplitter(ISplitter):
    ...
    _schema = Schema(Version(1, 0), {
        'process_kv': SimpleItem(
            defvalue=0, doc='Processing of kV scans: 0 - omitted;'
    ...
    def __init__(self):
        '''
        Create instance of PatientMvctSplitter..
        '''
        super(PatientMvctSplitter, self).__init__()
