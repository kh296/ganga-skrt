...
class PatientDataset(Dataset):
    ...
    _schema = Schema(
        ...
        {
            "paths": SimpleItem(
                defvalue=[], doc="List of paths to patient data"
            ),
        },
    )
    _category = "datasets"
    ...
    def write_paths_to_file_buffer(
        self, buffer_name="patient_data.py", buffer_subdir=os.curdir
    ):
        """
    ...
    def write_paths_to_file(self, out_path="patient_data.py"):
        ...
        if os.path.isdir(out_dir):
            ...
            with open(out_path_full, "w", encoding="utf-8") as out_file:
